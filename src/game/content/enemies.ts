...
const ARCHETYPES: readonly EnemyArchetype[] = [
  ...
  { id: 'black-banner', baseName: 'Black Banner Reaver', species: 'human', region: 'crownless-keep', baseHealth: 28, baseAttack: 8, baseArmor: 3, baseWard: 1, intents: { strike: 3, heavy: 4, guard: 1 }, traits: ['Executioner'], rewardTags: ['weapon', 'gold'], lore: 'A veteran who marches beneath a banner cut from a royal funeral cloth.', artFamily: 'warrior' },
