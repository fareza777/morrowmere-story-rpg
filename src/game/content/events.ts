...
const BLUEPRINTS: readonly Blueprint[] = [
  ...
  { id: 'gloamwood-hollow-tax', family: 'hollow-tax', region: 'gloamwood', title: 'The Hollow Tax', tone: 'violent', opening: 'Thorn-masked collectors have nailed a tax decree to every living tree and demand one memory from each traveler.', choiceA: ['Pay with a false memory', 'Build a lie convincing enough to survive the roots.', { focus: -2, gold: 12, addFlags: ['fooled-thorn-tax'] }, 'The decree drinks the lie and stamps your wrist with a seal meant for ghosts.', 'cunning', 8], choiceB: ['Burn the decree', 'Refuse a law written for the dead.', { health: -3, startCombat: 'thorn-penitent', faction: { abbey: -1 } }, 'The collectors unfold from the bark with hooked blades already raised.'] },
  { id: 'gloamwood-moth-queen-road', family: 'moth-queen', region: 'gloamwood', title: 'The Queen of Silver Wings', tone: 'mystic', opening: 'A human-sized moth sits upon a throne of pale cocoons, holding a lantern made from a sleeping knight’s helm.', choiceA: ['Ask for a road-dream', 'Let the moth show a path that exists only while remembered.', { focus: 3, corruption: 1, addFlags: ['dreamed-silver-road'] }, 'You wake with moonlit directions folded behind your eyes.', 'will', 8], choiceB: ['Free the sleepers', 'Cut open the cocoons before their dreams are harvested.', { mercy: 2, supplies: 1 }, 'The released pilgrims remember different centuries but agree to walk together.'] },
  { id: 'gloamwood-goblin-bell-market', family: 'bell-market', region: 'gloamwood', title: 'The Market Under One Bell', tone: 'hopeful', opening: 'Goblin merchants have built a night market beneath a bell too large for the forest, selling maps, soup, and carefully bottled courage.', choiceA: ['Buy bottled courage', 'Spend coin on a bravery that may not belong to you.', { gold: -7, attack: 1, addFlags: ['drank-borrowed-courage'] }, 'The bottle tastes of pepper and somebody else’s last stand.'], choiceB: ['Trade news for supper', 'Tell the market what waits on the drowned road.', { supplies: 2, faction: { freeHost: 1 }, mercy: 1 }, 'By midnight, every stall knows your warning and no one knows your name.'] },
  ...
  { id: 'drowned-road-upward-ferry', family: 'upward-ferry', region: 'drowned-road', title: 'The Ferry That Climbs', tone: 'mystic', opening: 'A stone ferry rises vertically through the rain, its drowned passengers seated as calmly as saints in a painted window.', choiceA: ['Climb aboard', 'Trust a vessel sailing toward the clouds.', { focus: -2, addFlags: ['rode-upward-ferry'], rewardTag: 'charm' }, 'For one impossible mile you see every road at once, including the one that follows your funeral.', 'will', 9], choiceB: ['Cut its anchor rope', 'Return the dead to the current below.', { mercy: 2, health: -2 }, 'The ferry falls without a sound. A hundred passengers finally close their eyes.'] },
  { id: 'drowned-road-orc-oath-stones', family: 'oath-stones', region: 'drowned-road', title: 'Stones That Keep Their Word', tone: 'hopeful', opening: 'Three orc veterans stand waist-deep in floodwater while ancient oath-stones repeat every promise ever broken on this road.', choiceA: ['Swear safe passage', 'Bind your name to strangers you may never meet.', { faction: { freeHost: 2 }, mercy: 1, addFlags: ['swore-road-oath'] }, 'The stones accept your promise and the current loosens around your legs.'], choiceB: ['Expose the oldest betrayal', 'Force the stones to name the king who broke the first oath.', { focus: -3, addFlags: ['first-betrayal-known', 'truth-known'], faction: { abbey: -1 } }, 'The answer cracks the largest stone straight through its carved mouth.', 'will', 9] },
  { id: 'drowned-road-chapel-under-water', family: 'underwater-chapel', region: 'drowned-road', title: 'The Chapel Below the Road', tone: 'mournful', opening: 'Through clear black water you see a dry chapel beneath the causeway, candles burning around soldiers who are still deciding whether they died.', choiceA: ['Descend and tell them', 'Give the lost company the truth it cannot reach alone.', { health: -3, mercy: 3, addFlags: ['dismissed-drowned-company'] }, 'Their captain salutes, and every candle becomes a bubble rising toward dawn.', 'will', 8], choiceB: ['Take the sealed reliquary', 'Leave their uncertainty intact and claim what it guards.', { corruption: 2, rewardTag: 'relic', startCombat: 'barrow-soldier' }, 'The chapel doors open. The soldiers decide that you are the enemy.'] },
  ...
  { id: 'embervault-saint-of-cinders', family: 'cinder-saint', region: 'embervault', title: 'The Saint Made of Cinders', tone: 'mournful', opening: 'A saint’s ash walks in the shape of a woman, gathering itself after every furnace gust to finish one final blessing.', choiceA: ['Kneel for the blessing', 'Let a dead faith spend what remains of itself.', { health: 7, ward: 1, faction: { abbey: 1 } }, 'A cool hand marks your brow, and the saint becomes ordinary dust.'], choiceB: ['Ask whom she failed', 'Trade comfort for the truth beneath sainthood.', { focus: -2, addFlags: ['saint-confessed'], faction: { abbey: -2 } }, 'She names the royal children used to temper the Crown, then scatters in relief.', 'will', 9] },
  { id: 'embervault-chain-smiths-bargain', family: 'oath-forge', region: 'embervault', title: 'A Bargain Hammered Shut', tone: 'ominous', opening: 'Three chain-smiths offer to forge your worst promise into armor, provided they may keep the person to whom it was made.', choiceA: ['Name the promise', 'Turn guilt into something that can stop a blade.', { armor: 2, corruption: 2, addFlags: ['wore-forged-promise'] }, 'The new plates whisper an absent name whenever they catch a blow.'], choiceB: ['Break their bargaining anvil', 'End a craft that treats people as payment.', { health: -4, mercy: 2, startCombat: 'iron-deserter' }, 'The smiths draw unfinished swords while the chains applaud.'] },
  { id: 'embervault-sleeping-anvil', family: 'sleeping-anvil', region: 'embervault', title: 'The Anvil That Dreams', tone: 'mystic', opening: 'An anvil the size of a chapel sleeps beneath the forge, dreaming weapons into existence around its iron heartbeat.', choiceA: ['Enter the metal dream', 'Search the armory imagined by a thing that has never seen war.', { focus: -3, rewardTag: 'weapon', addFlags: ['walked-anvil-dream'] }, 'You return carrying a blade designed to defeat an enemy not yet born.', 'will', 10], choiceB: ['Silence the heartbeat', 'Wake no more weapons into a wounded realm.', { mercy: 2, supplies: 1 }, 'The forge cools. Every unfinished sword exhales at once.', 'strength', 10] },
  ...
  { id: 'crownless-keep-empty-helms', family: 'empty-banquet', region: 'crownless-keep', title: 'The Banquet of Empty Helms', tone: 'violent', opening: 'Empty royal helms sit around a feast table, chewing with iron teeth while a crownless place waits at the head.', choiceA: ['Take the empty seat', 'Let the dead court mistake confidence for rank.', { focus: -2, gold: 18, addFlags: ['dined-with-helms'] }, 'The helms toast you as the only guest with a face, then reveal a servant’s passage.', 'cunning', 10], choiceB: ['Ring the dinner gong', 'Call whatever still commands this feast.', { health: -3, startCombat: 'black-banner', rewardTag: 'armor' }, 'The suits beneath the helms stand together, knives ringing against their plates.'] },
  { id: 'crownless-keep-last-scribe', family: 'last-scribe', region: 'crownless-keep', title: 'The Last Scribe of Morrowmere', tone: 'mournful', opening: 'A blind scribe writes your journey into a book whose final page is already stained with fresh black rain.', choiceA: ['Correct the royal record', 'Replace the court’s victories with the names it erased.', { focus: -3, mercy: 2, addFlags: ['rewrote-royal-record'], faction: { freeHost: 1 } }, 'The ink fights you, then settles into an honest history no king approved.', 'will', 10], choiceB: ['Read your final page', 'Learn the shape of the ending and risk becoming obedient to it.', { corruption: 2, addFlags: ['read-own-ending'] }, 'The page describes this exact choice, but the final sentence remains blank.'] },
