...
const ENCOUNTER_SPECS: readonly EncounterSpec[] = [
  ...
  { id: 'enc-ch01-warning-tree-penitents', enemyIds: ['thorn-penitent-01', 'thorn-penitent-01'], threatBudget: 8, compatibilityTags: ['hard-control', 'expeditionary'], counterplay: 'Cut the shared climbing rope to hinder one penitent, then keep the other away from the courier evidence.', reward: { xp: 38, gold: 13, itemChoices: [] } },
