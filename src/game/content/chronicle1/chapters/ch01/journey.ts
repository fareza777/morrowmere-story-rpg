...
export const CH01_JOURNEY = Object.freeze([
  ...
  defineScene({
    ...
    eligibility: { routes: ['kings-road', 'old-forest', 'ruined-pass'], minLevel: 1, maxLevel: 2 }, requirements: [], exclusions: [], cooldownRuns: 4, oneShot: true, followUps: ['ch02-main-the-royal-fletching'], callbackPromises: [],
    choices: [
