    ...
    choices: [
      {
        ...
        nextSceneId: 'ch01-combat-ditch-road-cutters',
        continueLabel: 'Move the repaired wagon',
      },
      {
        ...
        nextSceneId: 'ch01-combat-ditch-road-cutters',
        continueLabel: 'Return to the north road',
      },
    ],
  }),
  defineScene({
    ...
    choices: [
      {
        ...
        check: {
          ...
          criticalFailure: {
            outcome: 'The rear pair surges and tears a trace. A cinder signal flares from the ditch as two scouts rush the stalled wagons.',
            effects: [
      ...
      },
      {
        ...
        check: {
          ...
          criticalFailure: {
            outcome: 'The buried cord snaps around your ankle. A masked scout and a goblin torchling rise from the ditch before the drivers can pull you free.',
            effects: [
      ...
      },
      {
        ...
        check: {
          ...
          criticalFailure: {
            outcome: 'The pole twists from your grip as a cinder pot rises beyond the ditch and its two handlers rush the stalled wagons.',
            effects: [
              { type: 'vitals', health: -4 },
              { type: 'flag', operation: 'add', flagId: 'chalk-wheel-struck' },
              { type: 'threat', amount: 2 },
    ...
    choices: [
      {
        ...
        outcome: 'Jory matches the paired prints to the buried points. A fresh scrape shifts in the ditch ahead; whoever laid the trap stayed close.',
      ...
      },
      {
        ...
        detail: 'Clean the chalk away, bind any cuts, and steady the teams before taking the milestone road.',
        effects: [
          { type: 'vitals', resource: 2 },
          { type: 'flag', operation: 'add', flagId: 'chalk-horses-tended' },
          { type: 'tension', amount: 1 },
        ],
        outcome: 'With the teams settled and their cuts bound, the wagons roll on. No one leaves the convoy to chase the raiders into the ditch.',
        nextSceneId: 'ch01-living-cut-milestone-setup',
